...
class AdminStocksController {
    ...
    public function index() {
        ...
        view('dashboard/admin/stocks/index', [
            'posts' => $posts
        ]);
    ...
    public function create() {
        view('dashboard/header');
        view('dashboard/admin/stocks/create',[
    ...
    public function store() {
        ...
        header('location: ' . base_url('?pagename=admin-stocks-index') );
    ...
    public function edit( $id ) {
        ...
        view('dashboard/header');
        view('dashboard/admin/stocks/edit', [
            'post' => $model->find( $id ),
            'products' => model('ProductsModel')->all()
        ]);
        view('dashboard/footer');
